                                  ...
                                  elseif msg.content_.ID == "MessageContact" then
                                    if redis:sismember("botBOT-IDadmin",msg.sender_user_id_) then
                                      ...
                                      tdcli_function ({
                                        ...
                                        return send (msg.chat_id_, msg.id_, "<code>شماره به لیست مخاطب ها اضافه شد.✔️</code>\n➖➖➖\nChannel : @PerCyber\nCoder : @ghool")
                                      end
